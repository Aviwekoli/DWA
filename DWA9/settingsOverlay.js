export class SettingsOverlay extends HTMLElement {
    constructor(){
        super();
    ...
    connectedCallback(){
        ...
        this.shadowRoot.querySelector('[form="settings"]').addEventListener('submit', () => {
        event.preventDefault();
        event.target.reset();
        console.log('submit clicked')

        const theme = this.shadowRoot.querySelector('[data-settings-theme]');
    ...
    render(){
        ...
        * {
        ...
        <dialog class="overlay" data-settings-overlay open>
...
customElements.define('data-settings-overlay', SettingsOverlay);
